  ...
  <div>
    ...
    >
      <el-table-column
        ...
        sortable="custom"
      >
        <template #default="scope">{{ presenter(scope.row, 'timestamp') }}</template>
      </el-table-column>
      <el-table-column
        ...
        sortable="custom"
      >
        <template #default="scope">{{ presenter(scope.row, 'createdByEmail') }}</template>
      </el-table-column>
      <el-table-column
        ...
        sortable="custom"
      >
        <template #default="scope">{{ presenter(scope.row, 'entityName') }}</template>
      </el-table-column>
      <el-table-column :label="fields.action.label" :prop="fields.action.name" sortable="custom">
        <template #default="scope">{{ presenter(scope.row, 'action') }}</template>
      </el-table-column>
      <el-table-column
        ...
        sortable="custom"
      >
        <template #default="scope">{{ presenter(scope.row, 'entityId') }}</template>
      </el-table-column>
